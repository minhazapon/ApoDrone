...
const Contact = () => {
    ...
    return (
        ...
        <div class="lg:col-span-2 bg-[#0a4275] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
          <h2 class="text-3xl text-white text-center font-bold mb-6 droFont ">Contact us</h2>
          <form onSubmit={onSubmit}>
            ...
            <input type='text' required placeholder='Name'
              ...
              class="w-full bg-gray-100 rounded-lg py-3 px-6 text-sm outline-none" />
                <input type="number" required placeholder='Phone No.'class="w-full bg-gray-100 rounded-lg py-3 px-6 text-sm outline-none" name="Phone No." id="" />
                <textarea placeholder='Message' required rows="6"
                class="w-full bg-gray-100 rounded-lg px-6 text-sm pt-3 outline-none"></textarea>
              <input  class=" btn droFont text-gray-800 w-full relative bg-yellow-400 hover:bg-yellow-500 font-semibold rounded-lg text-sm px-6 py-3 !mt-6" type="submit" value="Submit" />
            </div>
          </form>
        </div>
        </div>
