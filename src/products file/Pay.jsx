...
<div class="font-[sans-serif] bg-white p-4 lg:max-w-7xl max-w-xl mx-auto droFont">
        ...
        <div class="lg:col-span-2 max-lg:order-1">
          ...
          <form onSubmit={onSubmit} class="mt-16 max-w-lg">
            ...
            <div class="grid gap-4 sm:grid-cols-2 mt-8">
              <div class="flex items-center">
                <input type="radio" required class="w-5 h-5 cursor-pointer" id="card" checked />
              ...
              <div class="flex items-center">
                <input type="radio" required class="w-5 h-5 cursor-pointer" id="paypal" />
            ...
            <div class="grid gap-4 mt-8">
              <input type="text" required placeholder="Cardholder's Name"
              ...
              <div class="grid grid-cols-2 gap-6">
                <input type="number" placeholder="EXP." required
                  class="px-4 py-3.5 bg-white text-gray-800 w-full text-sm border-b-2 focus:border-gray-800 outline-none" />
              ...
              <div class="flex items-center">
                <input id="remember-me" required name="remember-me" type="checkbox" class="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
            ...
            <div class="flex flex-wrap gap-4 mt-8">
              <input class=" btn min-w-[150px] px-6 py-3.5 text-sm bg-gray-800 text-white rounded-md hover:bg-[#111]" type="submit" value="Payment" />
            </div>
          </form>
        </div>
